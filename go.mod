module github.com/LinuxUserGD/hush
...
require (
	github.com/LinuxUserGD/dmcunrar-go v0.0.0-20240305014023-32e1993302a3 // indirect
	...
	github.com/getlantern/netx v0.0.0-20240124040039-163b1628a66b // indirect
